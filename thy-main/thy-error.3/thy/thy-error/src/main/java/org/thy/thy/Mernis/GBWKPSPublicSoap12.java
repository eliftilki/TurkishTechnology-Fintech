...
public class GBWKPSPublicSoap12
{
    interface GBWIWcfMethod
    {
        GBWExtendedSoapSerializationEnvelope CreateSoapEnvelope() throws java.lang.Exception;

        java.lang.Object ProcessResult(GBWExtendedSoapSerializationEnvelope __envelope,java.lang.Object result) throws java.lang.Exception;
    }
    ...
    public GBWKPSPublicSoap12(){}

    public GBWKPSPublicSoap12(String url)
    {
        this.url = url;
    }

    public GBWKPSPublicSoap12(String url,int timeOut)
    {
        this.url = url;
    ...
    protected GBWExtendedSoapSerializationEnvelope createEnvelope()
    {
        GBWExtendedSoapSerializationEnvelope envelope= new GBWExtendedSoapSerializationEnvelope(GBWExtendedSoapSerializationEnvelope.VER12);
        envelope.enableLogging = enableLogging;
    
        return envelope;
    }

    protected java.util.List sendRequest(String methodName,GBWExtendedSoapSerializationEnvelope envelope,org.ksoap2.transport.Transport transport ,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile )throws java.lang.Exception
    {
    ...
    java.lang.Object getResult(java.lang.Class destObj,java.lang.Object source,String resultName,GBWExtendedSoapSerializationEnvelope __envelope) throws java.lang.Exception
    {
        if(source==null)
        {
            return null;
    ...
    public Boolean TCKimlikNoDogrula(final Long TCKimlikNo,final String Ad,final String Soyad,final Integer DogumYili) throws java.lang.Exception
    {
        ...
        return (Boolean)execute(new GBWIWcfMethod()
        {
            @Override
            public GBWExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                GBWExtendedSoapSerializationEnvelope __envelope = createEnvelope();
            ...
            @Override
            public java.lang.Object ProcessResult(GBWExtendedSoapSerializationEnvelope __envelope,java.lang.Object __result)throws java.lang.Exception {
    ...
    protected java.lang.Object execute(GBWIWcfMethod wcfMethod,String methodName,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile) throws java.lang.Exception
    {
        org.ksoap2.transport.Transport __httpTransport=createTransport();
        __httpTransport.debug=enableLogging;
        GBWExtendedSoapSerializationEnvelope __envelope=wcfMethod.CreateSoapEnvelope();
        try
        {
    ...
    protected java.lang.Exception convertToException(org.ksoap2.SoapFault fault,GBWExtendedSoapSerializationEnvelope envelope)
    {
