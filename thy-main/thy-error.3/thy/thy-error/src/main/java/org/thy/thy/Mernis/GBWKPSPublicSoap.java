...
public class GBWKPSPublicSoap
{
    ...
    public GBWKPSPublicSoap(){}

    public GBWKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public GBWKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        GBWExtendedSoapSerializationEnvelope envelope= new GBWExtendedSoapSerializationEnvelope(GBWExtendedSoapSerializationEnvelope.VER11);
