...
class GBWSoapFaultEx extends org.ksoap2.SoapFault
{
    public Object fault;
}
...
public class GBWExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(GBWDateTimeConverter converter)
    {
        if(converter==null)
        {
            converter = new GBWStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static GBWDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static GBWDateTimeConverter dateTimeConverter = new GBWStandardDateTimeConverter();

    public GBWExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public GBWExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new GBWMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=GBWHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,GBWExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=GBWHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
